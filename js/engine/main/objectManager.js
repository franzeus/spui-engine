...
ObjectManager = {
    ...
    updateObject : function (object) {
        ...
        this.traverseObjects(function(object2) {
            ...
            if (!object.canCollideWithSameType && !object2.canCollideWithSameType && object.type === object2.type) {
                return;
            }
    ...
    collidedWithObject : function(object1, object2) {
        ...
        var collidedLeftTop     = isWithinArea(object2.x, object2.y, object1),
            ...
            collidedRightTop    = isWithinArea(object2.x + object2.width, object2.y, object1),
            collidedRightBottom = isWithinArea(object2.x + object2.width, object2.y + object2.height, object1),
            collidedMiddle      = isWithinArea(object2.x + (object2.width / 2), object2.y + (object2.height / 2), object1);
